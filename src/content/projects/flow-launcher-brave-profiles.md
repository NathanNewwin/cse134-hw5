...
summary: A personal Flow Launcher plugin that helps open and manage Brave browser profiles from a keyboard driven workflow.
technologies: Technologies include C#, Flow Launcher plugin development, launcher workflows, and browser profile management.
